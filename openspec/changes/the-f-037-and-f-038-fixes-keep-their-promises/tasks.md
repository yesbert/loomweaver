...
- [x] 1.6 Tests: a preview opened into the claiming workspace stays a preview; the arrangement adopted at sign-in gives the address shown its tab; a plugin opening content a claiming workspace holds beside another pane does not carry the address left
