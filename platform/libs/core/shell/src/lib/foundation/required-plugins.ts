 ...
 *
 * Naming a plugin this distribution does not compose, neither a trusted one it provides nor a
 * sandboxed one it declares, is a composition mistake rather than a failure: it is reported in
