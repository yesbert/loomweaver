...
| Type                   | What it is                                                                                                                                                                                                                                                                                                                                                            |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `CommandArgument`      | one declared argument: `SimpleCommandArgument` for `text`/`number`/`boolean`, `ChoiceCommandArgument` for a value out of a `choices` list, read when used for a plugin in the page (a getter offers values added later) and as registered for a sandboxed one. Both extend `CommandArgumentBase`, which carries the `name`, the `description`, `required` and `list`. |
