...
[authoring a weaver → content area](../authoring-a-weaver.md#content-area--routes--tabs), and the
distribution's side in
[building a distribution → content-area routing](../building-a-distribution.md#content-area-routing).
...
and closing, is in [host services](host-services.md).
...
[authoring a weaver](../authoring-a-weaver.md#sub-routes-and-pop-out-windows); the one rule to carry
