...
- [Switching capabilities off](../../building-a-distribution.md#switching-capabilities-off): every switch, what it takes away, and the declaration with `provideShellFeatures`.
