...
- [Content area: routes and tabs](../../authoring-a-weaver.md#content-area--routes--tabs): how a surface becomes a tab.
- [Following tabs](../../building-a-distribution.md#following-tabs) and [Routing](../routing.md).
