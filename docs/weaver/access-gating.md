...
to the platform. The whole shell re-gates reactively, with no reload (**signing out** just resets
that snapshot to anonymous). Complete, copyable components for both shapes, including the
