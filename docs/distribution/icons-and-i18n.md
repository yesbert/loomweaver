...
everything else, including every key a later release adds. That is the point: forking the shipped
bundle would leave you quietly behind on each update. It is applied last, so it also reaches the strings of a
weaver you bundle.
