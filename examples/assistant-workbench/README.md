...
named once, in `src/copilot/src/lib/agent/copilot-agent-source.ts`; the default is a free one, which
...
- `src/copilot/` is the assistant: the AG-UI connection the platform scaffolds, a panel, and the
